...
- **Motion** — Accent bars on hover, card lifts, reveal transitions.

## Pages

| Page | Purpose |
|---|---|
| `/` | The index — all 49 projects, generated from data |
| `/about.html` | The method, the rules, the totals |

## Stack

Vite multi-page build · Vanilla JS · CSS custom properties · GitHub Pages via Actions.
